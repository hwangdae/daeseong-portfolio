...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  // Case Study 4
  {
    ...
    title: "애니메이션 이미지 로딩 지연 UX 개선을 통한 사용자 경험 향상",
    problem: [
      {
        id: 1,
        title:
          "애니메이션 이미지를 사용하면서 페이지 로딩 시 프레임 드랍 문제 발생",
      },
    ],
    causes: [
      "일반 정적 이미지보다 파일 용량이 큼",
      "초기 화면 표시 전에 애니메이션 리소스가 준비되지 않아 시각적 끊김이 발생",
    ],

    solution: [
      {
        id: 1,
        title: "정적 fallback 이미지를 먼저 로드하도록 수정",
        subTitle: [
          "가벼운 정적 fallback 이미지를 먼저 렌더링하여 초기 화면 안정화",
          "브라우저 Image 객체를 활용해 애니메이션 WebP를 DOM에 마운트하지 않은 상태에서 백그라운드 선로딩",
          "로딩이 완료 되면 애니메이션 이미지로 교체 적용",
        ],
      },
    ],
    result: [
